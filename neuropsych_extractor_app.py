...
app_ui = ui.page_sidebar(
    ui.sidebar(
        ...
        ui.hr(),
        ui.download_button(
            "download_all", "📥 Download All CSVs", class_="btn-primary w-100"
        ),
        width=300,
    ),
    ui.navset_card_tab(
        ...
        ui.nav_panel("📋 Summary", ui.output_ui("summary_stats")),
        ui.nav_panel("🔍 Raw Preview", ui.output_text_verbatim("raw_preview")),
    ),
